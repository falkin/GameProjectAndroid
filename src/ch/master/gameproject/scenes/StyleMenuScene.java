...
public class StyleMenuScene extends Scene   implements IOnAreaTouchListener{
	...
	public StyleMenuScene(MainActivity mainActivity) {
	...
	public void loadInitScene() {
		...
		final int x = (int) (mainActivity.mCamera.getWidth() / 2 - InitRessources.initTextureRegionBackWorld
				.getWidth() / 2);
		final int y = (int) (mainActivity.mCamera.getHeight() / 2 - InitRessources.initTextureRegionBackWorld
				.getHeight() / 2);
	    SpriteBackground bg = new SpriteBackground(new Sprite(x, y-1,   InitRessources.initTextureRegionBackWorld,mainActivity.getVertexBufferObjectManager()));
		...
		playSprite = new Sprite(175,298,194,184,
				InitRessources.btWW,
